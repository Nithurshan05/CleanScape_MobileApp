...
export function SteetLightCompliant({navigation}) {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await addDoc(collection(db, "StreetLight Complaints"), {
        images,
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollView}>
        ...
        <TouchableOpacity style={styles.uploadButton} onPress={()=>{navigation.navigate("HomeScreen")}}>
